...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    <aside id="admin-sidebar" className="hidden lg:flex w-64 bg-white border-r border-slate-200 text-slate-900 flex-col h-screen sticky top-0 z-30 select-none shadow-xs">
      {/* Header Suzuki Genuine Parts Workshop Branding (Sticky top) */}
      ...
      <div className="flex-1 overflow-y-auto min-h-0 p-3 space-y-1 overscroll-contain">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className="tracking-wide font-sans truncate">{item.label}</span>
              </div>
            </a>
          );
        })}
      ...
      {/* Footer Return Link (Sticky bottom) */}
